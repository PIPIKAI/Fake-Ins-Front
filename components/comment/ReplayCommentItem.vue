<template>
    <div>
        ...
        <div v-for="item in Items" :key="item.id">
            {{ item.UserID }}->{{ReplyUser.Name}}
            <ReplayCommentItem v-if="Items.Replys != null" :Items="Items.Replys" :ReplyUser="ReplyUser"></ReplayCommentItem>
        </div>
        <!-- <div>ITEM::{{Items}}</div>
        <div>ReplyUser::{{ReplyUser}}</div> -->
        <!-- <div>user{{user}}</div> -->
        <!-- <v-row class="ma-0 ">
